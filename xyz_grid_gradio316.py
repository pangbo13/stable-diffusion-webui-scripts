...
class Script(scripts.Script):
    def title(self):
        return "X/Y/Z plot for Gradio 3.16"
    ...
    def ui(self, is_img2img):
        ...
        with gr.Row():
            with gr.Column(scale=19):
                with gr.Row():
                    ...
                    with gr.Column() as x_values_wrapper:
                ...
                with gr.Row():
                    ...
                    with gr.Column() as y_values_wrapper:
                ...
                with gr.Row():
                    ...
                    with gr.Column() as z_values_wrapper:
        ...
        def select_axis(axis_type,axis_values_dropdown):
            ...
            return gr.Button.update(visible=has_choices),gr.Textbox.update(visible=not has_choices),gr.update(choices=choices if has_choices else None,visible=has_choices,value=current_values),gr.update(visible=not has_choices)

        x_type.change(fn=select_axis, inputs=[x_type,x_values_dropdown], outputs=[fill_x_button,x_values,x_values_dropdown,x_values_wrapper])
        y_type.change(fn=select_axis, inputs=[y_type,y_values_dropdown], outputs=[fill_y_button,y_values,y_values_dropdown,y_values_wrapper])
        z_type.change(fn=select_axis, inputs=[z_type,z_values_dropdown], outputs=[fill_z_button,z_values,z_values_dropdown,z_values_wrapper])
